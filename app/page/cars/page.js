export default function car(){
    ...
    <div className="w-full h-full bg-white ">  
        <div className=" w-full h-72 backdrop-opacity-10 backdrop-invert bg-green-950/30 py-5 flex justify-evenly px-5">  
            <img src='/car/C.jpg' className="ml-4 mr-4 h-60 w-60"/>
            <p className="text-3xl"> Hyundai, Creta</p>
        </div>

        <div className="mt-5 w-full h-72 backdrop-opacity-10 backdrop-invert bg-green-950/30 py-5 flex justify-evenly px-5">  
